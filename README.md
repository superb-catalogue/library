...
1,512 books. 1,478 came from 46 of Standard Ebooks' subject and collection
...
no chapters at all. The rest arrived by hand, through `scripts/add_book.py`:
eight United States patents — Bell's telephone, Carlson's
electrophotography, the first cell phone, the Apple II, RSA, PageRank, a
method of exercising a cat, and Loos's nervous-system manipulation —
prepared from their Google Patents full text by `scripts/prepare_patent.py`,
and twenty-six Project Gutenberg titles from its most-read list — Alice,
Cthulhu, Twain on the Mississippi, Augustine's Confessions, the Sweeney Todd
penny dreadful — retypeset by `scripts/prepare_gutenberg.py`. More arrive as
more of Standard Ebooks' collections are added, as Standard Ebooks publishes
new editions, and as more books are typeset by hand.
